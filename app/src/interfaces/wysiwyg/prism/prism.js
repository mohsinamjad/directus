/* PrismJS 1.23.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+bash+c+csharp+cpp+docker+git+go+graphql+java+json+markdown+markup-templating+mongodb+nginx+php+promql+jsx+sass+sql+typoscript+yaml */
var _self =
